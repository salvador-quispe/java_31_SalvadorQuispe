...
public class miprimeracalculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        casilla.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(153, 255, 255), 1, true));
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        switch(this.operador){
                ...
                case "-":this.casilla.setText(sincero(this.primernumero-this.segundonumero));break;
                case "*":this.casilla.setText(sincero(this.primernumero*this.segundonumero));break;
                case "/":if(this.segundonumero==0) {this.casilla.setText("no hay resultado");}
                else{
